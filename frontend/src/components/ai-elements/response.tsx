  ...
  ({ className, ...props }: ResponseProps) => (
    <Streamdown
      className={cn(
        ...
        "prose-h1:mt-0 prose-h1:mb-4 prose-h1:text-3xl md:prose-h1:text-4xl prose-h1:font-semibold",
        "prose-h2:mt-8 prose-h2:mb-3 prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:font-semibold",
        ...
        "prose-pre:my-6 prose-pre:bg-muted prose-pre:border prose-pre:border-border prose-code:px-1 prose-code:py-0.5",
        // Blockquotes
        "prose-blockquote:my-5 prose-blockquote:border-l-4 prose-blockquote:border-border prose-blockquote:pl-4 prose-blockquote:italic",
        // Horizontal rule
        "prose-hr:my-8 prose-hr:border-0 prose-hr:h-px prose-hr:bg-border",
        // UI Separator component inside content
        "[&_[data-slot=separator]]:my-6",
        // Tables
        "prose-table:my-5 prose-th:font-semibold",
